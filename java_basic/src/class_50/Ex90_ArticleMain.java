...
class Article {
  ...
  //멤버변수에 할당된 값을 출력하는 print 멤버함수를 작성하시오
...
public class Ex90_ArticleMain {
  public static void main(String[] args) {
   //객체변수명 : article_1 ,  초기값 : 1, "JAVA-객체지향언어", "홍길동"
   
    Article article_1 = new Article(1, "Java-객체지향언어", "홍길동");
    Article article_2 = new Article(2, "JSP", "홍길동");
    
    //private 처리한 변수는 "객체변수명.프로퍼티" 형식으로 접근할 수 있다.
    article_2.print();
